...
<head>
  ...
  <title>Contact Us - Home Essentials</title>
</head>
...
<body>
      ...
      <div class="row justify-content-between">
        <div class="col-lg-5">
          <div class="intro-excerpt">
            <h1>Contact</h1>
            <p class="mb-4">We’re here to help! If you have any questions, feedback, or need assistance, please don’t hesitate to reach out. Our customer support team is available 24/7 to ensure you have the best shopping experience possible.</p>
            ...
            <div class="row mb-5">
              <div class="col-lg-4">
                <div class="service no-shadow align-items-center link horizontal d-flex active" data-aos="fade-left" data-aos-delay="0">
                  ...
                  <div class="service-contents">
                    <p>Firecrash, General Aviation Rd, Lapu-Lapu City, 6015 Cebu</p>
                  </div>
                </div>
              </div>
              ...
              <div class="col-lg-4">
                <div class="service no-shadow align-items-center link horizontal d-flex active" data-aos="fade-left" data-aos-delay="0">
                  ...
                  <div class="service-contents">
                    <p>johnlloydjustiniane13@gmail.com</p>
                  </div>
                </div>
              </div>
  ...
  <script>
    // Assume you have a variable that indicates if the user is logged in
    ...
    document.getElementById('contactForm').addEventListener('submit', function(event) {
      if (!isLoggedIn) {
        ...
        Swal.fire({
          ...
          text: 'You need to log in first before sending a message.',
          icon: 'warning',
