...
<head>
  ...
  <meta name="keywords" content="bootstrap, bootstrap4" />
		...
		<title>About Us - Home Essentials</title>
	</head>
					...
					<div class="row justify-content-between">
						<div class="col-lg-5">
							<div class="intro-excerpt">
								<h1>About Us</h1>
								<p class="mb-4">We strive to offer a diverse selection of quality products that cater to all your needs. Our commitment to exceptional customer service ensures that your shopping experience is seamless and enjoyable. Join us on our journey as we aim to bring you the best in online shopping!</p>
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-12 col-md-6 col-lg-3 mb-5 mb-md-0">
						<img src="images/johnlloyd1.png" class="img-fluid mb-5">
						<h3 clas><a href="https://www.facebook.com/johnlloydjustiniane13"><span class="">Justiniane </span>Johnlloyd</a></h3>
            <span class="d-block position mb-4">Student of University of Cebu Lapu-Lapu & Mandaue</span>
            <p>Lives in Firecrash, General Aviation Rd, Lapu-Lapu City, 6015 Cebu</p>
            <p class="mb-0"><a href="https://www.facebook.com/johnlloydjustiniane13" class="more dark">Learn More <span class="icon-arrow_forward"></span></a></p>			
				</div>
			</div>
		</div>
		<!-- End Team Section -->
